...
class MyProcessingAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, configuration, p_str=None, Any=None, *args, **kwargs):
        ...
        self.addParameter(QgsProcessingParameterNumber(
            ...
            minValue=1, maxValue=1000000000, type=1)  # type=1 is Double, 0 is int
        )
        ...
        param_constant = QgsProcessingParameterNumber(
            ...
            minValue=0.001, maxValue=1000000.000, type=1  # type=1 is Double, 0 is int
        )
