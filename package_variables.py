...
long_name = 'Create QGIS Plugin'  # what users see in the QGIS plugin repository and on the RTD toc
pdf_title = 'How to create a QGIS plugin'  # the front page title on the read the docs PDF version
...
bitbucket_home = 'https://bitbucket.org/kul-reseco/create-qgis-plugin'  # home page of bitbucket
bitbucket_src = 'https://bitbucket.org/kul-reseco/create-qgis-plugin/src'  # src page of bitbucket
bitbucket_issues = 'https://bitbucket.org/kul-reseco/create-qgis-plugin/issues'  # issue page of bitbucket

read_the_docs = 'https://create-qgis-plugin.readthedocs.io'  # read the docs page (check URL is free)
